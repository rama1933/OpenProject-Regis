                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a href="{{ route('pendaftaran_balik_tambah') }}"
                                            class="btn btn-primary float-right">
                                            <i class="fa fa-plus"> Tambah</i></a>
                                        {{-- @endif --}}
                                        <h3 class="card-title">Data Pendaftaran Balik Nama</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        @if (session('message'))
                                        ...
                                        <div id="cetak_filter" class="mb-4">
                                            ...
                                            <form action="{{ url('') }}/pendaftaran_balik_pdf" class="form-inline">
                                            ...
                                            <table id="table" class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>KTP</th>
                                                        <th>KTP Pemilik Baru</th>
                                                        <th>Kwitansi Pembelian</th>
                                                        <th>Pajak</th>
                                                        <th>Stnk</th>
                                                        <th>Bpkb</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ url('') }}/storage/{{ $pendaftaran->ktp_baru }}"
                                                                target="_blank" class="btn btn-sm btn-primary edit">
                                                                <i class="fa fa-download">
                                                                </i>
                                                            </a>
                                                        ...
                                                        <td>
                                                            <a href="{{ url('') }}/storage/{{ $pendaftaran->kwitansi_pembelian }}"
                                                                target="_blank" class="btn btn-sm btn-primary edit">
                                                                <i class="fa fa-download">
                                                                </i>
                                                            </a>
                                                        ...
                                                        <td> <a href="{{ route('pendaftaran_balik_edit',$pendaftaran->id) }}"
                                                                class="btn btn-sm btn-primary my-2"> <i
                                                                    class="fa fa-pen">
                                                                </i></a>
                                                            <a href="{{ route('pendaftaran_balik_hapus',$pendaftaran->id) }}"
