...
class TblMasterPendaftaran5Tahun extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_master_pendaftaran_5_tahun', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_master_pendaftaran_5_tahun');
    }
}
