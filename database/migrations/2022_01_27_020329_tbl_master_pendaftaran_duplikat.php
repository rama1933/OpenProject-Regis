...
class TblMasterPendaftaranDuplikat extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_master_pendaftaran_duplikat', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_master_pendaftaran_duplikat');
    }
}
